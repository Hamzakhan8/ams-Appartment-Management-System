...
<div class="row">
  <div class="col-xs-12">
    ...
    <div id="you" class="alert alert-success alert-dismissable" style="display:<?php echo $addinfo; ?>">
      ...
      <?php echo $msg; ?> </div>
    <div align="right" style="margin-bottom:1%;"> <a class="btn btn-success" data-toggle="tooltip" href="<?php echo WEB_URL; ?>floor/addfloor.php" data-original-title="<?php echo $_data['add_floor'];?>"><i class="fa fa-plus"></i></a> 
    </div>
    <div class="box box-success">
      ...
      <div class="box-body">
        ...
        <?php
			...
			// $result = mysqli_query($link,"SELECT tbl_add_floor.*, tblbranch.* FROM tbl_add_floor INNER JOIN tblbranch ON tbl_add_floor.branch_id = tblbranch.branch_id ORDER BY tbl_add_floor.fid DESC;");
			$result = mysqli_query($link, "SELECT tbl_add_floor.*, tblbranch.*, tbl_add_owner.*
            FROM tbl_add_floor
            INNER JOIN tblbranch ON tbl_add_floor.branch_id = tblbranch.branch_id
            INNER JOIN tbl_add_owner ON tbl_add_floor.ownid = tbl_add_owner.ownid
            ORDER BY tbl_add_floor.fid DESC");
