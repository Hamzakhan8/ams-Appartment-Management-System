<?php 
   ...
   if(isset($_GET['id']) && $_GET['id'] != ''){
   	...
   	$result = mysqli_query($link,"SELECT 
                  ar.rid,ar.amount ,ar.r_name,ao.o_name,tb.branch_name,ar.r_floor_no,ar.r_unit_no,ar.amount
                  ...
                  WHERE ar.rid = ".$_GET['id']."
                  ORDER BY ar.rid DESC
              ");
      while($row = mysqli_fetch_array($result)){
   		$floor_no = $row['r_floor_no'];
   		$unit_no = $row['r_unit_no'];
         ...
         <form onSubmit="return validateMe();" action="<?php echo $form_url; ?>" method="post" enctype="multipart/form-data">
            <div class="box-body row">
               <div class="form-group col-md-6">
                  ...
                  <input  type="text" name="txtRentName" value="<?php echo $rented_name;?>"  id="txtRentName" class="form-control" />
