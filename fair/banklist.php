        ...
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
            ...
            <?php 
              ...
              $resss = mysqli_query($link, "SELECT * FROM `tbl_emi_payment` AS emi WHERE rid = ".$row['rid']." AND payment_by = 2 AND `status` = 2");
              while ($pay = mysqli_fetch_array($resss)) {
