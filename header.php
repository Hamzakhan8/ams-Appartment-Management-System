   ...
   <body class="skin-green sidebar-mini">
         ...
         <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="navbar-custom-menu">
               <ul class="nav navbar-nav">
                  <li class="hidden-xs" > <a href="javascript:;" data-toggle="modal" data-target="#available_room"><i style="font-size:18px;" class="fa fa-home"></i></a> </li>
                  <li class="hidden-xs" > <a href="<?php echo WEB_URL; ?>visitor/visitorlist.php"><i style="font-size:18px;" class="fa fa-user-o"></i></a> </li>
                  <li class="hidden-xs" > <a href="<?php echo WEB_URL; ?>complain/complainlist.php"><i style="font-size:18px;" class="fa fa-comments"></i></a> </li>
                  <li class="hidden-xs" > <a href="<?php echo WEB_URL; ?>mailsms/mailsms.php"><i style="font-size:18px;" class="fa fa-envelope-o"></i></a> </li>
                  <!-- User Account: style can be found in dropdown.less -->
                  <li class="dropdown user user-menu">
                     <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img class="user-image" src="<?php echo !empty($image) ? $image : 'img/no_image.jpg'; ?>"> <span class="hidden-xs"> <?php echo $_SESSION['objLogin']['name']; ?> </span> </a>
                     <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                           <div class="col-md-12" style="margin-bottom: 10px;">
                              ...
                              <div><a href="javascript:;" data-toggle="modal" data-target="#switch_branch" class="btn btn-warning btn-flat" style="width:100%"><?php echo $_data['user_branch_switcher']; ?></a></div>
                              <?php } ?>
                           </div>
      ...
      <aside class="main-sidebar">
         ...
         <section class="sidebar" >
            ...
            <ul class="sidebar-menu"style="width:auto;">
               <li class="<?php if($page_name != '' && $page_name == 'dashboard'){echo 'active';}?>">
                  <a href="<?php echo WEB_URL; ?>dashboard.php"><i class="fa fa-line-chart"></i> <span><?php echo $_data['menu_dashboard']; ?></span></a> 
               </li>
               <li class="treeview <?php if($page_name != '' && $page_name == 'addowner' || $page_name == 'ownerlist'){echo 'active';}?>">
               ...
               <li class="<?php if($page_name != '' && $page_name == 'branchlist' || $page_name == 'addbranch'){echo 'active';}?>">
                  <a href="#"><i class="fa fa-building"></i><span><?php echo $_data['branch'];?></span> <i class="fa fa-angle-left pull-right"></i> </a>
                  <ul class="treeview-menu">
               ...
               <li class="treeview <?php if($page_name != '' && $page_name == 'addfloor' || $page_name == 'floorlist'){echo 'active';}?>">
               ...
               <li class="treeview <?php if($page_name != '' && $page_name == 'addunit' || $page_name == 'unitlist'){echo 'active';}?>">
               ...
               <li class="treeview <?php if($page_name != '' && $page_name == 'addrent' || $page_name == 'rentlist'){echo 'active';}?>">
               ...
               <!-- <li class="treeview <?php if($page_name != '' && $page_name == 'addemployee' || $page_name == 'employeelist' || $page_name == 'employee_salary_setup' || $page_name == 'leave_request_list'){echo 'active';}?>">
               ...
               <li class="treeview <?php if($page_name != '' && $page_name == 'addfair' || $page_name == 'fairlist' || $page_name == 'banklist' || $page_name == 'cashlist' ){echo 'active';}?>">
                  ...
                  <ul class="treeview-menu">
                     ...
                     <li class="<?php if($page_name != '' && $page_name == 'banklist'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>fair/banklist.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_bank_list']; ?></a></li>
                     <li class="<?php if($page_name != '' && $page_name == 'cashlist'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>fair/cashlist.php"><i class="fa fa-angle-double-right"></i><?php echo $_data['menu_cash_list']; ?></a></li>


                  </ul>
               </li>
               <!-- <li class="treeview <?php if($page_name != '' && $page_name == 'add_owner_utility' || $page_name == 'owner_utility_list'){echo 'active';}?>">
               ...
               <li class="treeview <?php if($page_name != '' && $page_name == 'add_maintenance_cost' || $page_name == 'maintenance_cost_list'){echo 'active';}?>">
               ...
               <!-- <li class="treeview <?php if($page_name != '' && $page_name == 'add_m_committee' || $page_name == 'm_committee_list'){echo 'active';}?>">
               ...
               <!-- <li class="treeview <?php if($page_name != '' && $page_name == 'add_fund' || $page_name == 'fund_list'){echo 'active';}?>">
               ...
               <li class="treeview <?php if($page_name != '' && $page_name == 'add_bill' || $page_name == 'bill_list'){echo 'active';}?>">
               ...
               <li class="treeview <?php if($page_name != '' && $page_name == 'addcomplain' || $page_name == 'complainlist'){echo 'active';}?>">
               ...
               <!-- <li class="treeview <?php if($page_name != '' && $page_name == 'addvisitor' || $page_name == 'visitorlist'){echo 'active';}?>">
               ...
               <li class="treeview <?php if($page_name != '' && $page_name == 'addmeeting' || $page_name == 'meetinglist'){echo 'active';}?>">
               ...
               <li class="treeview <?php if($page_name != '' && $page_name == 'notice' || $page_name == 'employee_notice' || $page_name == 'owner_notice'){echo 'active';}?>">
               ...
               <li class="treeview <?php if($page_name != '' && $page_name == 'fair_report' || $page_name == 'rented_report' || $page_name == 'visitors_report' || $page_name == 'complain_report' || $page_name == 'unit_report' || $page_name == 'fund_status' || $page_name == 'bill_report' || $page_name == 'salary_report'){echo 'active';}?>">
               ...
               <?php if((int)$_SESSION['login_type'] == 5){ ?>
               <li class="treeview <?php if($page_name != '' && $page_name == 'cleardata' || $page_name == 'visitorlist'){echo 'active';}?>">
