...
<div class="row">
  <div class="col-xs-12">
    ...
    <div id="you" class="alert alert-success alert-dismissable" style="display:<?php echo $addinfo; ?>">
      ...
      <?php echo $msg; ?> </div>
    <div align="right" style="margin-bottom:1%;"> <a class="btn btn-success" data-toggle="tooltip" href="<?php echo WEB_URL; ?>owner/addowner.php" data-original-title="<?php echo $_data['add_new_owner_breadcam'];?>"><i class="fa fa-plus"></i></a>  </div>
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
            <?php
				$_units = array();
				$result = mysqli_query($link,"Select * from tbl_add_owner order by ownid desc");
            ...
            <tr>
              ...
              <td><?php echo $row['o_per_address']; ?></td>
              <!-- <td><?php
				 $i=1;
